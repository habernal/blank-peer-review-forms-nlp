...
A collection of blank peer-review forms for various NLP/ML venues and journals.
...
* TMLR (Transactions of Machine Learning Research)
  * Review: [tmlr.md](tmlr.md)
  * Recommendation: [tmlr-recommendation.md](tmlr-recommendation.md)
